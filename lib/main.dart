...
import 'package:my_gym/Screens/edit_profile.dart';
    ...
    return ScreenUtilInit(
      builder: () => MultiProvider(
        providers: [
          ...
          ChangeNotifierProxyProvider<SportProvider, UsersProvider>(
              create: (_) => UsersProvider(SportProvider()),
              update: (context, sportprovider, userprovider) {
                return UsersProvider(sportprovider);
              }),
